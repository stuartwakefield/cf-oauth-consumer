...
<!--- Configure our consumer --->
<cfset twitterConsumer = CreateObject( "component", "oauth.com.Consumer" )/>
<cfset signer = CreateObject( "component", "oauth.com.HMACSHA1Signer" )/>
<cfset twitterConsumer.setConsumerKey( "" )/>
<cfset twitterConsumer.setConsumerSecret( "" )/>
<cfset twitterConsumer.setSigner( signer )/>
